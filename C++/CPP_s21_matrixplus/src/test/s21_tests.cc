...
TEST(MatrtixTest, CreateMatrix) {
  S21_Project::S21Matrix mat = S21_Project::S21Matrix(2, 2);
  S21_Project::S21Matrix* point = new S21_Project::S21Matrix(4, 4);
  point->FillRandMatrix();
  delete point;
  EXPECT_EQ(mat.GetCols(), 2);
  EXPECT_THROW(S21_Project::S21Matrix n(-1, 2), std::exception);
  EXPECT_THROW(S21_Project::S21Matrix n(1, 0), std::exception);
  EXPECT_THROW(S21_Project::S21Matrix n(nullptr, 1, 0), std::exception);
}

TEST(MatrtixTest, MoveMatrix) {
  double data[4] = {2, 1, 2, 4};
  S21_Project::S21Matrix matrix1(data, 2, 2);
  S21_Project::S21Matrix matrix2 = std::move(matrix1);
  S21_Project::S21Matrix matrix3(data, 2, 2);
...
TEST(MatrtixTestFunction, EqMatrix) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix3 = S21_Project::S21Matrix(dataNew, 2, 2);
...
TEST(MatrtixTestFunction, SumMatrixFunction) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix3 = S21_Project::S21Matrix(dataout, 2, 2);
...
TEST(MatrtixTestFunction, MulMatrixFunctionWithExeption) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix3 = S21_Project::S21Matrix(dataout, 3, 2);
  matrix1.SetRows(3);
  EXPECT_EQ(matrix1.EqMatrix(matrix3), true);
  EXPECT_THROW(matrix1 * matrix3, std::exception);
}
...
TEST(MatrtixTestFunction, TrancFunction) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2(matrix1);
...
TEST(MatrtixTestFunction, CalcComplemencFunction) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2;
  matrix2 = matrix1.CalcComplements();
  S21_Project::S21Matrix matrix3 = S21_Project::S21Matrix(dataout, 2, 2);
  EXPECT_EQ(matrix2.EqMatrix(matrix3), true);
  matrix2.SetRows(4);
  EXPECT_THROW(matrix2.CalcComplements(), std::exception);
  S21_Project::S21Matrix matrixNULL = std::move(matrix2);
  EXPECT_THROW(matrix2.CalcComplements(), std::exception);
  S21_Project::S21Matrix matrix4(1, 1);
  matrix4.SetValue(0, 0, 2);
  S21_Project::S21Matrix matrix5 = matrix4.CalcComplements();
...
TEST(MatrtixTestFunction, DeterminantFunction) {
  ...
  S21_Project::S21Matrix matrix2 = S21_Project::S21Matrix(data1, 3, 3);
...
TEST(MatrtixTestFunction, InverseMatrixFunction) {
  ...
  S21_Project::S21Matrix ZeroDet(data1, 3, 3);
  EXPECT_THROW(ZeroDet.InverseMatrix(), std::exception);
  double data2[1] = {2};
  S21_Project::S21Matrix matrix4(data2, 1, 1);
  S21_Project::S21Matrix tt = matrix4.InverseMatrix();
...
TEST(MatrtixTestOperator, MulNumberOperator) {
  ...
  double dataout[4] = {4, 2, 4, 8};
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2 = S21_Project::S21Matrix(dataout, 2, 2);
  matrix1 = matrix1 * 2;
...
TEST(MatrtixTestOperator, FunctionFillint) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix matrix2(2, 2);
  matrix2.FillInt();
...
TEST(MatrtixTestOperator, FunctionPrint) {
  ...
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  matrix1.Print();
  S21_Project::S21Matrix deleter = std::move(matrix1);
  EXPECT_THROW(matrix1.Print(), std::exception);
}

TEST(MatrtixTestOperator, FunctionClear) {
  double data[4] = {0, 1, 2, 3};
  S21_Project::S21Matrix matrix1 = S21_Project::S21Matrix(data, 2, 2);
  S21_Project::S21Matrix cleared(2, 2);
  matrix1.ClearMatrix();
  EXPECT_EQ(matrix1 == cleared, true);
}
